...
export const sampleEvents: TimelineEvent[] = [
  ...
  { id: 7, userId: 4, property: undefined, parentId: null, scope: "page", tabId: 4, action: "loadData", date: "2025-09-03T12:00:05.000Z" },
  { id: 8, userId: 5, property: undefined, parentId: null, scope: "left", tabId: 5, action: "loadSettings", date: "2025-09-03T12:00:05.500Z" },
  { id: 9, userId: 6, property: undefined, parentId: null, scope: "page", tabId: 6, action: "loadData", date: "2025-09-03T12:00:06.000Z" },
  { id: 10, userId: 7, property: undefined, parentId: null, scope: "widget", tabId: 7, action: "click", date: "2025-09-03T12:00:06.500Z" },
  { id: 11, userId: 8, property: undefined, parentId: null, scope: "page", tabId: 8, action: "loadData", date: "2025-09-03T12:00:07.000Z" },
  { id: 12, userId: 9, property: undefined, parentId: null, scope: "left", tabId: 9, action: "loadSettings", date: "2025-09-03T12:00:07.500Z" },
  { id: 13, userId: 10, property: undefined, parentId: null, scope: "page", tabId: 10, action: "loadData", date: "2025-09-03T12:00:08.000Z" },
  { id: 14, userId: 11, property: undefined, parentId: null, scope: "widget", tabId: 11, action: "click", date: "2025-09-03T12:00:08.500Z" },
  { id: 15, userId: 12, property: undefined, parentId: null, scope: "page", tabId: 12, action: "loadData", date: "2025-09-03T12:00:09.000Z" },
];
